...
<div id="kt_app_header" class="app-header">
    ...
    <div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-none d-lg-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
            <a href="<?=base_url()?>">
                <img alt="Logo" src="<?=base_url()?>/public/assets/media/logos/bessy-logo2.png" class="h-20px h-lg-30px app-sidebar-logo-default theme-light-show">
                <img alt="Logo" src="<?=base_url()?>/public/assets/media/logos/bessy-logo2.png" style="filter: grayscale(200%) invert(100%) brightness(1.2);" class="h-20px h-lg-30px app-sidebar-logo-default theme-dark-show">
            </a>
        </div>
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="../../demo1/dist/index.html" class="d-lg-none">
                <img alt="Logo" src="<?=base_url()?>/public/assets/media/logos/bessy-logo2.png" class="h-30px">
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-title">About Systems</span>
                            <span class="menu-arrow d-lg-none"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                                ...
                                <div class="tab-content py-4 py-lg-8 px-lg-7">
                                    ...
                                    <div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages" role="tabpanel">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-4">
                                                <img src="<?=base_url()?>/public/assets/media/stock/600x600/img-82.jpg" class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
                                    ...
                                    <div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account" role="tabpanel">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-7">
                                                <img src="<?=base_url()?>/public/assets/media/stock/900x600/46.jpg" class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
                                    ...
                                    <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities" role="tabpanel">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 pe-lg-5">
                                                <img src="<?=base_url()?>/public/assets/media/stock/600x600/img-84.jpg" class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
                                    ...
                                    <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets" role="tabpanel">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-8">
                                                <img src="<?=base_url()?>/public/assets/media/stock/900x600/44.jpg" class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-title">MICTO Team</span>
                            <span class="menu-arrow d-lg-none"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="<?= base_url()?>/public/assets/media/avatars/<?= $userInformation->user_photo?$userInformation->user_photo:"default-avatar.png"?>" class="user-avatar" alt="user">
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true" style="">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="<?=base_url()?>/public/assets/media/avatars/<?=$userInformation->user_photo?$userInformation->user_photo:"default-avatar.png"?>" class="user-avatar">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <div class="menu-item px-5">
                            <a href="<?= $userInformation->role==3?base_url("profile"):'#'?>" class="menu-link px-5">My Profile</a>
                        </div>
                        <div class="menu-item px-5">
...
<div class="modal fade" tabindex="-1" id="my-profile-modal">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3 row">
                    <input type="file" name="user_photo" id="user-photo" class="w-100" hidden>
                    <label for="user-photo" class="d-block col-4 user-photo-hover pointer">
                        <div class="p-2 border mx-auto d-inline-block bg-light rounded position-relative">
                            <img src="<?=base_url()?>/public/assets/media/avatars/<?=$userInformation->user_photo?$userInformation->user_photo:"default-avatar.png"?>"
                                class="rounded img-fluid user-avatar" style="" alt="Profile picture">
                            <div
                    ...
                    <div class="col-8 pt-2">
                        <h2><?=$userInformation->firstname?> <?=$userInformation->lastname?></h2>
                        <div class="border-bottom pb-3 ">
                            <?php if($userInformation->role == 3):?>
                                <b class="text-gray-600"><?=$userInformation->contact_number?></b><br>
                            <?php else:?>
                                <b class="text-gray-600"><?=$userInformation->department_name?></b><br>
                            <?php endif;?>
                            <i class="far fa-envelope"></i><span class="text-gray-500">
                                <?=$userInformation->email?></span>
                        </div>
                        <span class="badge badge-light-success mt-2">Admin</span>
                    </div>
                </div>

                <div class="separator separator-dashed my-10"></div>

                <form method="POST" id="my-profile-form">
                    <input type="number" value="<?=$userInformation->user_id?>" name="id" readonly hidden>
                    <div class="mb-8 text-center ">
                        <h3 class="mb-3">Edit Account Information</h3>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="required form-label">Email address</label>
                        <input type="email" class="form-control form-control-lg form-control-solid" id="exampleFormControlInput1"
                            placeholder="name@example.com" value="<?=$userInformation->email?>" name="email">
                    </div>
                    <div class="mb-5">
                        <div class="">
                            <label class="required fs-6 fw-semibold mb-1">Username</label>
                            <input type="username" class="form-control form-control-lg form-control-solid form-control-lg form-control-solid" placeholder="Enter Valid Username"
                                name="username" id="username" value="<?=$userInformation->username?>">
                    ...
                    <div class="mb-3">
                        <label for="user-firstname" class="required form-label">Firstname</label>
                        <input type="text" class="form-control form-control-lg form-control-solid" id="user-firstname" name="firstname" placeholder="Enter Firstname" value="<?=$userInformation->firstname?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="user-middlename" class="form-label">Middlename</label>
                        <input type="text" class="form-control form-control-lg form-control-solid" id="user-middlename" name="middlename" placeholder="Enter Middlename" value="<?=$userInformation->middlename?>">
                    </div>
                    <div class="mb-3 mx-0 row g-0">
                        <div class="col-<?=$userInformation->role==3?'8':'12'?>">
                            <label for="user-lastname" class="required form-label">Lastname</label>
                            <input type="text" class="form-control form-control-lg form-control-solid" id="user-lastname" name="lastname" placeholder="Enter Lastname" value="<?=$userInformation->lastname?>" required>
                        </div>
                        <?php if($userInformation->role==1):?>
                            <div class="col-4 ps-3">
                                <label for="user-lastname" class="form-label">Suffix</label>
                                <input type="text" class="form-control form-control-lg form-control-solid" id="user-suffix" name="suffix" placeholder="Suffix" value="<?=$userInformation->suffix?>">
                            </div>
                        <?php endif;?>
                    </div>
                    ...
                    <div class="mb-3 mx-0 row g-0">
                        <div class="col-6">
                            ...
                            <input type="date" class="form-control form-control-lg form-control-solid" id="birthdate" name="birthdate" placeholder="Enter Birthdate" required="" value="<?=$userInformation->birthdate?>">
                        </div>
                        <?php if($userInformation->role==3):?>
                            <div class="col-6 ps-3">
                                <label class="required fs-6 fw-semibold mb-2">Sex</label>
                                <select class="form-control form-select form-control-solid" name="sex" id="user-sex">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text border-0" id="contact-number-prefix">+63</span>
                            <input type="text" class="form-control form-control-solid mask-contact-number" id="contact-number" name="contact_number" placeholder="900-000-0000" pattern="^9[0-9]{2}-[0-9]{3}-[0-9]{4}$" max-length="12" value="<?=$userInformation->contact_number?>" aria-describedby="contact-number-prefix">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label class="required fs-6 fw-semibold mb-2">Address</label>
                        <select class="form-control form-select form-select-search form-control-solid" name="" id="user-province">
                            <option value="Male">Male</option>
                            <option value="Female">Female</option>
                        </select>
                    </div>
                    ...
                    <input type="submit" value="submit" hidden id="user-form-submit">
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <label class="btn btn-primary" for="user-form-submit">Save changes</label>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="mb-3 current-password-container">
                        <label for="current-password" class="required form-label">Current Password</label>
                        <div class="input-group">
                            <input type="password" class="form-control password-target" id="current-password"
                            placeholder="Current Password" value="" name="current_password">
                            <button type="button" class="input-group-text password-toggle pointer"><i class="ri-eye-off-line"></i></button>
                        </div>
                    </div>
                    <div class="mb-3 new-password-container" style="display: none;">
                        <label for="new-password" class="required form-label">New Password</label>
                        <div class="input-group">
                            <input type="password" class="form-control password-target" id="new-password"
                            placeholder="New Password" value="" name="new_password">
                            <button type="button" class="input-group-text password-toggle pointer"><i class="ri-eye-off-line"></i></button>
                        </div>
                    </div>
                    <div class="mb-3 new-password-container" style="display: none;">
                        <label for="repeat-new-password" class="required form-label">Repeat New Password</label>
                        <div class="input-group">
                            <input type="password" class="form-control password-target" id="repeat-new-password"
                            placeholder="Repeat New Password" value="" name="repeat_new_password">
                            <span class="input-group-text password-toggle pointer"><i class="ri-eye-off-line"></i></span>
                        </div>
                    </div>
                    <small class="alert alert-danger p-2" style="display:none;" id="change-password-error">Error</small>
                </form>
            </div>
            <div class="modal-footer border-0">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary change-password-submit">Submit</button>
            </div>
        </div>
    </div>
</div>
