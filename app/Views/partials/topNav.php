            ...
            <div class="collapse navbar-collapse active" id="topnav-menu-content">
                <ul class="navbar-nav active">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu active" aria-labelledby="topnav-apps">
                            ...
                            <a href="apps-tickets.html" class="dropdown-item active"><i class="ri-customer-service-2-line align-middle me-1"></i> Tickets</a>
                        </div>
                    </li>
