                    ...
                    <div class="app-search-box dropdown">
                        ...
                        <div class="dropdown-menu dropdown-lg" id="search-dropdown">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle" src="<?= base_url()?>/public/assets/images/users/avatar-2.jpg" alt="Generic placeholder image" height="32">
                                        <div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle" src="<?= base_url()?>/public/assets/images/users/avatar-5.jpg" alt="Generic placeholder image" height="32">
                                        <div>
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="pro-user-name ms-1">
                        <?= $userInformation->email ?> <i class="mdi mdi-chevron-down"></i>
                    </span>
                </a>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <!-- <li class="dropdown d-none d-xl-block">
                ...
                <div class="dropdown-menu">
                    item
                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#new-ticket-modal">
