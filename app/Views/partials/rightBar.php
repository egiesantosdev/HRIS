<div class="right-bar">
        ...
        <div class="tab-content pt-0">
            ...
            <div class="tab-pane active" id="settings-tab" role="tabpanel">
                ...
                <div class="p-3">
                    ...
                    <a href="https://wrapbootstrap.com/theme/minton-admin-dashboard-landing-template-WB0858DB6?ref=coderthemes" class="btn btn-danger mt-2" target="_blank"><i class="mdi mdi-basket me-1"></i> Purchase Now</a>
                    </div>
    ...
    </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 867px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 141px; display: block; transform: translate3d(0px, 0px, 0px);"></div></div></div> <!-- end slimscroll-menu-->
</div>