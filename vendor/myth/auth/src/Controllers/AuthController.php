...
class AuthController extends Controller
{
	...
	public function attemptRegister()
	{
		...
		if ($this->config->requireActivation !== null)
		{
			...
			if (! $sent)
			{
				...
				return redirect()->back()->withInput()->with('error', site_url('activate-account') . '?token=' . $user->activate_hash ?? lang('Auth.unknownError'));
			}	
	...
	public function activateAccount()
	{
		...
		if (is_null($user))
		{
			// return redirect()->route('register')->with('error', lang('Auth.activationNoUser'));
		}
	...
	public function searchApplication(){
		return $this->_render($this->config->views['searchApplication'], ['config' => $this->config]);
	}

	public function searchResult(){
		return $this->_render($this->config->views['searchResult'], ['config' => $this->config]);
	}
}
