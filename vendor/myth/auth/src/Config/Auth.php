...
class Auth extends BaseConfig
{
	...
	public $views = [
		...
		'searchApplication' => 'Myth\Auth\Views\others\buildingPermitSearchPage',
		'searchResult' => 'Myth\Auth\Views\others\buildingPermitSearchResult',
	];
	...
	public $userActivators = [
		'Myth\Auth\Authentication\Activators\EmailActivator' => [
			'fromEmail' => 'hris-no-reply@baliwag.gov.ph',
			'fromName' => 'Human Resource Information System | City of Baliwag',
		],
	];
