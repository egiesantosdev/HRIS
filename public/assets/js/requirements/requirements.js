                ...
                if(response.status){
                    ...
                    $('#additionalDocs-cont').append(
                        '<tr>'+
                            ...
                            '<td>'+
                                '<a class = "btn btn-primary btn-sm" href = "'+response.url+'" target = "_blank"><span class = "ri-eye-line"></span></a>'+
                                '<a class = "btn btn-primary btn-sm" href = "'+response.url+'" target = "_blank" download><span class = "ri-eye-line"></span></a>'+
                            '</td>'+
                        '</tr>'
                    );
